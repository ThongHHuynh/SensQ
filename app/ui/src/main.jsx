...
import { Activity, Anchor, Camera, Home, Map, Route, Settings, Server } from "lucide-react";
...
function App() {
  ...
  const pages = {
    home: (
      <HomePage
        {...robotState}
        onOpenDocking={() => setActiveTab("docking")}
    ...
    mission: <MissionPage robot={robotState.robot} />,
