...
```python
from coverage_planner.coverage_geometry import Cell, Segment
...
from coverage_planner.coverage_geometry import Waypoint
from coverage_planner.grid_utils import is_safe
...
```bash
python3 -m py_compile src/coverage_planner/coverage_planner/*.py
colcon build --packages-select coverage_planner

ros2 launch coverage_planner production_path.launch.py
...
from coverage_planner.cell_decomposition import decompose_cells, row_intervals
...
from coverage_planner.coverage_geometry import Waypoint
from coverage_planner.transition_planner import connect, line_safe
