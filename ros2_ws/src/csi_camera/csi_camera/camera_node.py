...
class JetsonCsiCamera(Node):
    def __init__(self) -> None:
        ...
        # The mounting bracket has the sensor rolled 180 deg from its
        # original orientation; this rotates the published image back to
        # right-side-up in hardware, ahead of cv_bridge and calibration.
    ...
    def create_pipeline(
        ...
        # nvvidconv flip-method: 0=none, 2=rotate 180 deg.
